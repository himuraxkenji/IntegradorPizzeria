...
insert into pedidos(id_pedido, fecha, id_cliente,numero_pedido) values(nextval('seq_pedidos'),'2019-11-17 20:10:25-07',1, 1 );

insert into pedidos (id_pedido, fecha, id_cliente,numero_pedido) values(nextval('seq_pedidos'),'2019-11-18 21:15:25-07', 2, 2);
